...
public class Scorer2014 {
		...
		while ((line = keyReader.readLine()) != null) {
			...
			try {
				if(fields[7].contains(":"))
					eclass=Integer.parseInt(fields[7].split(":")[1]);
				else
	...
	static List<String> listValuedSlots = Arrays.asList(
			...
			"gpe:births_in_city","gpe:headquarters_in_country","org:holds_shares_in","gpe:employees_or_members","gpe:member_of"
			);
	/*
	...
	static String slotType (String slot) {
		...
		if (slotFields.length != 2) {
			System.out.println("Invalid slot length" + slot);
			return "error";
		}
